...
M.prototype.cancel=function(a){0==this.b&&Qc(function(){var b=new Bd(a);Dd(this,b)},this)};
...
mf("//web.archive.org/web/20181207021815/https://static.doubleclick.net/instream/ad_status.js",a);yf.push(uf(function(){zf||"google_ad_status"in window||(sf("//web.archive.org/web/20181207021815/https://static.doubleclick.net/instream/ad_status.js",a),zf=!0,P("DCLKSTAT",3))},5E3))}}
function Bf(){return parseInt(Q("DCLKSTAT",0),10)}
;function Cf(){this.f=!1;this.b=null}
Cf.prototype.initialize=function(a,b,c,d,e){b?(this.f=!0,mf(b,function(){this.f=!1;window.botguard?Df(this,c,d):(rf(b),R(Error("Unable to load Botguard from "+b),"WARNING"))}.bind(this),e)):a&&(eval(a),window.botguard?Df(this,c,d):R(Error("Unable to load Botguard from JS"),"WARNING"))};
...
c.ha=function(a,b){xg(m);da(a,b)}}try{S("use_fetch_for_op_xhr")?De(l,e):Me(l,e)}catch(Cd){if("InvalidAccessError"==Cd)m&&(xg(m),m=0),R(Error("An extension is blocking network request."),"WARNING");
else throw Cd;}m&&vf(function(){yg(a)},0,5E3)}
;var Ag=A().toString();
...
b=Ge("//web.archive.org/web/20181207021815/https://googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof Bd&&b.abort();
return yd(a)})}
...
;function yi(a){if("1"!==bb(he(),"args","privembed")){a&&ie();try{xi().then(function(a){a=le(a);a.bsq=zi++;Me("//web.archive.org/web/20181207021815/https://www.youtube.com/ad_data_204",{wa:!1,C:a,withCredentials:!0})},function(){}),T(yi,18E5)}catch(b){R(b)}}}
...
/*
     FILE ARCHIVED ON 02:18:15 Dec 07, 2018 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 07:26:04 May 29, 2025.
...
playback timings (ms):
  ...
  esindex: 0.014
  cdx.remote: 1153.398
  LoadShardBlock: 354.494 (6)
  PetaboxLoader3.datanode: 456.684 (8)
  load_resource: 408.378 (2)
  PetaboxLoader3.resolve: 123.768 (2)
*/